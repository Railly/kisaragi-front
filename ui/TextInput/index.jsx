export default function TextInput({
  ...
  return (
    <div className="w-full px-3">
      ...
      <input
        className="block w-full px-4 py-3 mt-2 text-base leading-tight text-gray-700 transition rounded appearance-none ring-gray-200 ring-2 focus:ring-blue-400 focus:outline-none focus:bg-white"
        id={name}
        type={type}
        name={name}
        placeholder={label}
